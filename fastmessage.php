...
<head>
    ...
    <link href="assets/css/dm.css?5" rel="stylesheet">
        ...
        <div class="fastmessagebg">
            <div class="bg-dark d-flex align-items-center justify-content-center target-border">
                <div class="border-content">
                    <img src="students/avatars/<?= $auth->getUserById($db, $_GET['target'])->avatar; ?>" class="rounded-circle" height="40px" width="40px">
                </div>
                <div class="border-content">
                ...
                <div class="border-content">
                    <a href="deletedm.php?name=<?= $dm->getPrivateMessage($db, $auth->getUserById($db, $_GET['target'])->name, $auth->getStudent()->name); ?>" class="btn btn-danger closebutton" role="button"><i class="fas fa-times-circle"></i></a>
                </div>
            </div>
                ...
                <div class="chat">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="entry" rows="1" data-min-rows="1" placeholder="Ecrivez votre message içi... (SHIFT+Entrée pour sauter une ligne)"></textarea>
                        </div>
